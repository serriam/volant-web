...
gulp.task('minify:html', gulp.series('minify-front:html'));
...
gulp.task('copy:dist:html', gulp.series('copy-front:dist:html', 'copy-base:dist:html'));
...
gulp.task('copy:dist:assets', gulp.series('copy-front:dist:assets'));
